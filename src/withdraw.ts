...
async function main(): Promise<void> {
    ...
    const globalConfig = {
        ...
        timeout: 3600,
        obtcAddress: "orai10g6frpysmdgw5tdqke47als6f97aqmr8s3cljsvjce4n5enjftcqtamzsd",
        senderChain: {
    ...
    const destAddressWithRightPrefix = toBech32(OraiBtcLocalConfig.prefix, addressData);
    ...
    const tx = await client.execute(
        ...
        globalConfig.obtcAddress,
        {
          send: {
            ...
            amount: Decimal.fromAtomics(globalConfig.amount.toString(), 8).toString(),
            msg: toBinary({
